...
if [ "$darwin" = "true" ]; then
    case $JVM_ARCH in
    x86_64)
        JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.7_macos-x64_bin.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.7_macos-x64_bin-f78cdc
        ;;
    arm64)
        JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.7_macos-aarch64_bin.tar.gz
        JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.7_macos-aarch64_bin-95ca44
        ;;
    *)
    ...
    JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.7_windows-x64_bin.zip
    JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.7_windows-x64_bin-f2a1b6
else
    JVM_ARCH=$(linux$(getconf LONG_BIT) uname -m)
     case $JVM_ARCH in
        x86_64)
            JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.7_linux-x64_bin.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.7_linux-x64_bin-a8f33a
            ;;
        aarch64)
            JVM_URL=https://download.oracle.com/java/21/archive/jdk-21.0.7_linux-aarch64_bin.tar.gz
            JVM_TARGET_DIR=$BUILD_DIR/jdk-21.0.7_linux-aarch64_bin-79c0b7
            ;;
        *)
            die "Unknown architecture $JVM_ARCH"
            ;;
